<?php
include_once("../registration/server.php");
include_once("db.php");
?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="e0">
        ...
        <a href="http://localhost/blog/posts/index.php">
            <div class="e1"><img src="../slike/funny-logo.png" style="height: 150px;width: 150 px"></div>
        </a>
